...
include($path_to_root . "/admin/db/mod_batch_number_db.php");
...
if ($Mode == 'ADD_ITEM' || $Mode == 'UPDATE_ITEM') {
    ...
    if ($input_error != 1) {
        if ($selected_id != -1) {
            update_item_category($selected_id, $_POST['description'], $_POST['tax_type_id'], $_POST['sales_account'], $_POST['cogs_account'], $_POST['inventory_account'], $_POST['adjustment_account'], $_POST['wip_account'], $_POST['units'], $_POST['mb_flag'], $_POST['dim1'], $_POST['dim2'], check_value('no_sale'), check_value('no_purchase'));
            set_batch_number_id($selected_id, $_POST['batch_number_id']);
            display_notification(_('Selected item category has been updated'));
        } else {
            $category_id=add_item_category($_POST['description'], $_POST['tax_type_id'], $_POST['sales_account'], $_POST['cogs_account'], $_POST['inventory_account'], $_POST['adjustment_account'], $_POST['wip_account'], $_POST['units'], $_POST['mb_flag'], $_POST['dim1'], $_POST['dim2'], check_value('no_sale'), check_value('no_purchase'));
            set_batch_number_id($category_id, $_POST['batch_number_id']);
...
if ($dim < 2)
    hidden('dim2', 0);
batch_number_master_list_row(_("Batch number format"), "batch_number_id", $_POST['batch_number_id']);
end_table(1);
div_end();
