...
ALTER TABLE `Z_batch_number_master` ADD PRIMARY KEY (`id`);
ALTER TABLE `Z_batch_number_master` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;COMMIT;
...
ALTER TABLE `Z_batch_number_assign` ADD PRIMARY KEY (`id`);
ALTER TABLE `Z_batch_number_assign` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;COMMIT;
