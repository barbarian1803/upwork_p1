...
--
-- Host: localhost
-- Generation Time: Jul 26, 2017 at 04:34 PM
...
(26, 26, 3, 1, '2016-05-07 07:59:01', NULL, 1, '2016-05-07', 0),
...
--
-- Table structure for table `0_mod_batch_number_assign`
--
...
--
-- Dumping data for table `0_mod_batch_number_assign`
--
...
--
-- Table structure for table `0_mod_batch_number_master`
--
...
--
-- Dumping data for table `0_mod_batch_number_master`
--

INSERT INTO `0_mod_batch_number_master` (`id`, `string_format`, `serial_no`) VALUES
(1, 'PACK-%Y%m%d-%no', 1),
(4, 'asfsdfsdfbdfgdfgdf', 1);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Administrator', 2, '', 'adm@example.com', 'C', 0, 0, 0, 0, 'default', 'Letter', 2, 2, 4, 1, 1, 0, 0, '2017-07-26 09:20:39', 10, 1, 1, '1', 1, 0, 'orders', 30, 0, 1, 0, 0, 0);
...
--
-- Indexes for table `0_mod_batch_number_assign`
--
ALTER TABLE `0_mod_batch_number_assign`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `0_mod_batch_number_master`
--
ALTER TABLE `0_mod_batch_number_master`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `0_gl_trans`
  MODIFY `counter` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
--
...
ALTER TABLE `0_item_tax_types`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `0_mod_batch_number_assign`
--
ALTER TABLE `0_mod_batch_number_assign`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `0_mod_batch_number_master`
--
ALTER TABLE `0_mod_batch_number_master`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
