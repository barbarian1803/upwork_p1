...
if (isset($_GET['AddedID'])) {
    ...
    hyperlink_no_params_new_tab("$path_to_root/mod_barcode/barcode_generator.php?trans_type=".$stype."&trans_id=".$id, _("Generate barcode"));
    br();
...
if ((isset($_POST['Process']) || isset($_POST['ProcessAndClose'])) && can_process($wo_details) == true) {
    ...
    $id = work_order_produce($_POST['selected_id'], $_POST['ref'], input_num('quantity'), $_POST['date_'], $_POST['memo_'], $close_wo, $_POST["batch_number"]);
